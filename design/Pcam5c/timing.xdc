...
create_clock -period 1.667 -name video_dynclk [get_pins -regexp design_1_i/video_dyclk/inst/CLK_CORE_DRP_I/clk_inst/mmcm_adv_inst/CLKOUT0 -hierarchical]
...
create_clock -period 6.734 -name pixel_dynclk [get_pins -regexp design_1_i/DVIClocking_0/inst/PixelClkBuffer/O -hierarchical]

# MIPI D-PHY data rate 420Mbps/lane = 210 MHz HS_Clk
#create_clock -period 4.761 -name dphy_hs_clock_p -waveform {0.000 2.380} [get_ports mipi_phy_if_clk_hs_p]
